            ...
            <div id="planche3" class="planche planche3">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <p id="texteGeo">La Bulgarie est un pays situé au Nord de la Grèce et de la Turquie. Elle est bordée par la mer Noire. Sa capitale, Sofia est également sa plus grande ville avec 1.4 million d’habitants (⅕ de la population totale de la Bulgarie). Le pays a un IDH élevé (0.777). Sa langue principale est le bulgare (c’est d’ailleurs le seul pays où elle est langue principale, même si d’autres pays parlent le bulgare).</p>
                    </div>
