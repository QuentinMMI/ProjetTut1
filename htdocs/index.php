    ...
    <body>
        ...
        <main id="pageAccueil">
            ...
            <div id="planche3" class="planche planche3">
                ...
                <p class="descriptionBulgarie">La Bulgarie est un pays situé au Nord de la Grèce et de la Turquie. Il est bordé par la mer Noire. <br><br> Sa capitale, Sofia est également sa plus grande ville avec 1.4 million d’habitants (⅕ de la population totale de la Bulgarie). Le pays a un IDH élevé (0.777).<br> Sa langue principale est le bulgare (c’est d’ailleurs le seul pays où elle est langue principale, même si d’autres pays parlent le bulgare).<br><br>Chaque année, la Bulgarie accueille 8.9 millions de touristes, principalement des pays Européens frontaliers, pour sa culture et son vin.
                </p>
            </div>
        </main>
