 ...
 */ 
  function convertirImage85x85 ($nomFichierAConvertir, $nomFichierConverti) {
    $imageSource = $nomFichierAConvertir;
    ...
    imageCopyResampled($imageReechantillonne,$imageSource,0,0,0,0,$largeurImageReechantillonne, $hauteurImageReechantillonne, $largeurImageSource, $hauteurImageSource);
