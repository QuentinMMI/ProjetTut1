...
<main> 
        <div id="planche1" class="planche planche1">
            ...
            <div id="Lequipe">
                <img id="imgThomas1" class="photoEquipe" src="images/imgThomas1.png" alt="image de Thomas">
                <img id="imgFlorian1" class="photoEquipe" src="images/imgFlorian1.png" alt="image de Florian">
                <img id="imgThomas2" class="photoEquipe" src="images/imgThomas2.png" alt="image de Quentin">
                <img id="imgFlorian2" class="photoEquipe" src="images/imgFlorian2.png" alt="image de Hugo">
                <img id="imgThomas3" class="photoEquipe" src="images/imgThomas3.png" alt="image de Joanne">
            </div>
